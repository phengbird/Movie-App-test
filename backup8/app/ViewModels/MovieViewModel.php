...
class MovieViewModel extends ViewModel
{
    ...
    public function movies()
    {
        return collect($this->movies)->merge([
            'poster_path' => $this->movies['poster_path'] ?'https://image.tmdb.org/t/p/w500'.$this->movies['poster_path'] : '/img/no-image.jpg',
            ...
            'cast' => collect($this->movies['credits']['cast'])->take(5)->map(function($cast){
                return collect($cast)->merge([
                    'profile_path' => $cast['profile_path'] ? 'https://image.tmdb.org/t/p/w300'.$cast['profile_path'] : '/img/no-photo.jpg'
                ]);
            }),
