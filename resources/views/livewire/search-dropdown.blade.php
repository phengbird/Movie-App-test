...
<div class="relative mt-3 md:mt-0">
    <input wire:model.debounce.500ms="search" type="text" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:shadow-outline focus:outline-none" placeholder="Search">
                ...
                <ul>
                    @foreach ($searchResults as $results)
                        <li class="border-b border-gray-700">
                            <a href="{{ route('movie.show' , $results['id']) }}" class="block hover:bg-gray-700 px-3 py-3 flex items-center">
