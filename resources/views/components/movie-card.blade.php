<div>
    <div class="mt-8">
        <a href=" {{ route('movie.show',$movies['id']) }}">
            <img src="{{"https://image.tmdb.org/t/p/w500".$movies['poster_path']}}" alt="{{$movies['title']}}" class="hover:opacity-75  transition ease-in-out duration-150">
        </a>

        <div>
            <a href="#" class="text-lg mt-2 hover:text-gray:300">{{$movies['title']}}</a>
