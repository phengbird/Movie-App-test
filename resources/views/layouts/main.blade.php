...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b" border-gray-800>
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 px-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-3 md:mt-0">
                    <input type="text" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:shadow-outline focus:outline-none " placeholder="Search">
